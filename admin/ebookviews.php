...
<head>
    ...
    <title>KLTG ADMIN - E-book Views</title>
...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">E-book Views</h1>
                        ...
                        <div class="col-xl-6 col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">E-book Views</h6>
                                </div>
                                <div class="card-body">
                                    <?php
                                    $query2 = "SELECT sum(ebook_view)+sum(ebook_view2) FROM `ebook`";
                                    $result = mysqli_query($db, $query2);
                                    while ($row = mysqli_fetch_assoc($result)) {

                                        $totalviewsoverall = $row['sum(ebook_view)+sum(ebook_view2)'];
                                    }   
                                    ?>

                                    <?php
                                    $query = "SELECT *, ebook_view+ebook_view2 FROM `ebook` ORDER BY ebook_view+ebook_view2 DESC LIMIT 5";
                                    $result = mysqli_query($db, $query);
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        echo '<h4 class="small font-weight-bold">' . $row['ebook_name'] . ' <span class="float-right">' . $row['ebook_view+ebook_view2'] . '</span></h4>';
                                        echo '<div class="progress mb-4">';
                                        echo '<div class="progress-bar bg-danger" role="progressbar" style="width: ' . $row['ebook_view+ebook_view2'] / $totalviewsoverall * 100 . '%" aria-valuenow="' . $row['ebook_view'] . '" aria-valuemin="0" aria-valuemax="100"></div></div>';
                        ...
                        <div class="col-xl-6 col-lg-6 h-100 w-100">
                            <div class="card shadow mb-4 h-100">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Total E-book Views</h6>
                                ...
                                <div class="card-body h-100 w-100">
                                    <div class="row h-100 w-100">
                                        <div class="col h-100">
                                            ...
                                            $query = "SELECT *, sum(ebook_view)+sum(ebook_view2) FROM `ebook`  ";
                                            $result = mysqli_query($db, $query);
                                            while ($row = mysqli_fetch_assoc($result)) {

                                            echo'<p class="font-weight-bold text-center " style="font-size:10vh">
                                               '. $row['sum(ebook_view)+sum(ebook_view2)'].'
                                                </p>';
                                            }
    ...
    <script src="js/ebookviews.js"></script>
    <script>document.getElementById("ebooknav").classList.add('active');</script>
