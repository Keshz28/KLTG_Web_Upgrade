 ...
 *                            emailcampaign.php
 *
 *   Admin — compose/send email campaigns to subscribers.
 *
...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Email Campaign
                            </h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable2" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        $query = "SELECT * FROM emailcampaign ORDER BY id DESC";
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            <tr>
                                                ...
                                                $query2 = "SELECT * FROM mailqueue WHERE init_time LIKE '%$time%'  ";
                                                $result2 = mysqli_query($db, $query2);
                                                $rowcount = mysqli_num_rows($result2);
                                                
                                                $query4 = "SELECT * FROM mailqueue WHERE init_time LIKE '%$time%'  AND sendstatus='1'";
                                                $result4 = mysqli_query($db, $query4);
                                                $rowcount4 = mysqli_num_rows($result4);
                                                ?>
                                                <td>
                                                   <?php echo $rowcount4; ?>/<?php echo $rowcount; ?>
                                                </td>


                                                <?php

                                                $query3 = "SELECT * FROM pageview WHERE  qr='$title'";
    ...
    <script>document.getElementById("campaignnav").classList.add('active');</script>
