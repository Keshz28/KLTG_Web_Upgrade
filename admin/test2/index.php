...
<body>
    ...
    <header id="header" class="header fixed-top" data-scrollto-offset="0">
        <div class="container-fluid d-flex align-items-center justify-content-between">
            ...
            <a class="btn-getstarted scrollto" href="index.php?logout=1">Logout</a>
    ...
    <main id="main">
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th scope="col"><a href="#" class="" data-bs-toggle="modal"
                                    data-bs-target="#exampleModal"><i class="bi bi-plus-circle"></i><a></th>
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            if (!$row['banner_order']) {
                                ...
                                echo '<td>
                                <a href="#" class="" onclick="newmodal(' . $row['banner_id'] . ' );" id="modaledit"><i class="bi bi-pencil-fill"></i></a>
                                </td>';
                                ...
                                echo '<td>
                                <a href="#" class="" onclick="newmodal(' . $row['banner_id'] . ' );" id="modaledit"><i class="bi bi-pencil-fill"></i></a>
                            <a href="?orderup=' . $row['banner_order'] . '&banner_id=' . $row['banner_id'] . '"><i class="bi bi-caret-up-fill"></i></a>
                            <a href="?orderdown=' . $row['banner_order'] . '&banner_id=' . $row['banner_id'] . '"><i class="bi bi-caret-down-fill"></i></a>
                            </td>';
        ...
        <div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel2"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel2">Edit Banner</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form action="index.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <input class="form-control" id="exampleFormControlTextarea8" rows="3" name="id"
                                hidden></input>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="exampleFormControlTextarea2" rows="3"
                                    name="order"></input>
                            </div>
