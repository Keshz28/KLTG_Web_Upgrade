...
function blogpost() {
  ...
  xhttp.open(
    "GET",
    "https://www.googleapis.com/blogger/v3/blogs/1732826187557117921/posts?key=AIzaSyARErRCSmyD1dikK0ndYipEuORgXIeLRB8&fetchImages=true&maxResults=4&labels=" +
      labels,
    true
  );
...
function gettags() {
  ...
  var string =
    "https://www.googleapis.com/blogger/v3/blogs/1732826187557117921/posts?key=AIzaSyARErRCSmyD1dikK0ndYipEuORgXIeLRB8&maxResults=500";
...
function initblog() {
  const xhttp = new XMLHttpRequest();
  var string =
    "https://www.googleapis.com/blogger/v3/blogs/1732826187557117921/posts?key=AIzaSyARErRCSmyD1dikK0ndYipEuORgXIeLRB8&fetchImages=true&maxResults=4";
...
//   const xhttp = new XMLHttpRequest();
//   var stringget =
//     "https://www.googleapis.com/blogger/v3/blogs/1732826187557117921/posts?key=AIzaSyC7NA9vDhkVtk4lWisJxGW--fYXLIeM__w&fetchImages=true&maxResults=5&pageToken=" +
//     nextpagetoken;
...
//   } else {
//     var stringget =
//       "https://www.googleapis.com/blogger/v3/blogs/1732826187557117921/posts?key=AIzaSyC7NA9vDhkVtk4lWisJxGW--fYXLIeM__w&fetchImages=true&maxResults=5";
//   }
  ...
  xhttp.onload = function () {
    ...
    if (data.length !== 0) {
      ...
      for (var i = 0; i < data.items.length; i++) {
        ...
        "        </a>" +
        '        <a href="https://twitter.com/share?text=Check Out This Article&url=' + data.items[i].id + '" class="twitter">' +
