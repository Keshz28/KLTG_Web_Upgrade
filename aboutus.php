        ...
        <div class="row g-4 g-lg-5" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-5">
            <div class="about-img-1">
              <img src="assets/img/aboutus/kltg_backdrop_1.png" class="img-fluid" alt="">
              <img src="assets/img/aboutus/KLTG52.png" class="img-fluid" alt="">
            </div>
          </div>
          ...
          <div class="col-lg-7">
            ...
            <p>With official approval from the Ministry of Transport, and distribution across airports, railway and bus terminals, 
              embassies, tourism offices, hotels, shopping malls, and even international markets, KL The Guide ensures that advertisers 
              reach travellers exactly where they are looking for information.</p>

            <p>Backed by one of the largest travel media networks in Malaysia with over 16 million reach across all platforms, 
              KL The Guide is more than a publication; it is a gateway to discovery for travellers and a high-value media platform 
              for businesses.</p>

            <p><strong>Trusted by Travelers. Powered by Bluedale Publishing.</strong></p>
        ...
        <div class="row g-4 g-lg-5" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-5 order-1 order-lg-2 ">
            <div class="about-img-2">
              <img src="assets/img/aboutus/KLTG app.png" class="img-fluid" alt="">
            </div>
          </div>

          <div class="col-lg-7 order-2 order-lg-1">
            <h3 class="pt-0 pt-lg-5">Your Pocket Companion to Kuala Lumpur
            </h3>
            ...
            <p>Kuala Lumpur is a city of contrasts: modern skyscrapers standing tall beside heritage buildings, diverse cuisines bursting with flavour, 
              and communities that celebrate a rich blend of traditions. KL The Guide curates this unique spirit into clear, easy-to-navigate sections, 
              ensuring you have the right insights to discover, experience, and enjoy the city with confidence.</p>
